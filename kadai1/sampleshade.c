...
void init(void) {
  ...
  for (int i = 0; i <= NUM_DIV; i++) {
    vtnr[2 * i][2] = vtnr[2 * i][5] = vtnr[2 * i + 1][2] = vtnr[2 * i + 1][5] =
        cos(2 * M_PI / NUM_DIV * i);
    vtnr[2 * i][0] = vtnr[2 * i][3] = vtnr[2 * i + 1][0] = vtnr[2 * i + 1][3] =
        sin(2 * M_PI / NUM_DIV * i);
    vtnr[2 * i][1] = 1;
    vtnr[2 * i + 1][1] = -1;
    vtnr[2 * i][4] = vtnr[2 * i + 1][4] = 0;
  }
